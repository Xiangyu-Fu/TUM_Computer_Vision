function DrawLines(app)
    ...
    plot([orx(1) irx(1)], [ory(1) iry(1)], 'r','Parent', app.UIAxes_2);
    plot([vx irx(2)], [vy iry(2)], 'r-.','Parent', app.UIAxes_2);
    plot([orx(2) irx(2)], [ory(2) iry(2)], 'r','Parent', app.UIAxes_2);
    plot([vx irx(3)], [vy iry(3)], 'r-.','Parent', app.UIAxes_2);
    plot([orx(3) irx(3)], [ory(3) iry(3)], 'r','Parent', app.UIAxes_2);
    plot([vx irx(4)], [vy iry(4)], 'r-.','Parent', app.UIAxes_2);
    plot([orx(4) irx(4)], [ory(4) iry(4)], 'r','Parent', app.UIAxes_2);
